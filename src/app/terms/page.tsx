export default function TermsPage() {
  return (
    <main style={{ maxWidth: 600, margin: '0 auto', padding: '40px 20px', fontFamily: '-apple-system, sans-serif', color: '#1A1A1A', lineHeight: 1.8 }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 20 }}>Terms of Service</h1>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 24, marginBottom: 8 }}>Results</h2>
      <p>Results vary from person to person. Cortilow does not guarantee specific outcomes. The effectiveness of the program depends on your adherence to the daily missions and your individual circumstances.</p>

      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 24, marginBottom: 8 }}>User content</h2>
      <p>You retain ownership of any photos or data you create within the app. We do not claim any rights over your content.</p>

      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 24, marginBottom: 8 }}>Limitation of liability</h2>
      <p>Cortilow is provided "as is" without warranties of any kind. We are not liable for any damages arising from your use of the app.</p>

      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 24, marginBottom: 8 }}>Contact</h2>
      <p>For questions about these terms, contact us at: support@cortilow.com</p>
    </main>
  )
}
